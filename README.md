...
| [Power Analysis: Part 1](writeups/cylabacademy/cryptography/power-analysis-part-1/) | cryptography | — | hard | `side-channel`, `aes`, `cpa`, `dpa`, `scared`, `pwntools`, `numpy`, `python` |
